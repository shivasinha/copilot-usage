...
PRICING_TABLE = {
    ...
    # OpenAI GPT-4.1 family (included/free in Copilot; API pricing for cost estimates)
    "gpt-4.1":             (2.00,   8.00, 0.50,  0.00),
    "gpt-4.1-mini":        (0.40,   1.60, 0.10,  0.00),
    "gpt-4.1-nano":        (0.10,   0.40, 0.025, 0.00),
    # OpenAI GPT-5 family
    "gpt-5":               (10.00, 40.00, 2.50,  0.00),
    "gpt-5-mini":          (1.10,   4.40, 0.275, 0.00),
    "gpt-5.2":             (2.00,   8.00, 0.50,  0.00),
    "gpt-5.3":             (2.00,   8.00, 0.50,  0.00),
    "gpt-5.4":             (2.00,   8.00, 0.50,  0.00),
    "gpt-5.4-mini":        (0.40,   1.60, 0.10,  0.00),
    "gpt-5.4-nano":        (0.10,   0.40, 0.025, 0.00),
    # xAI Grok
    "grok-code-fast":      (0.50,   1.50, 0.00,  0.00),
